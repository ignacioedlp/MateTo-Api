 ...
 */
var AccessControl = {
  checkIfIsTheSameVendorOrAdminProduct: function checkIfIsTheSameVendorOrAdminProduct() {
    return /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
        var _req$headers$authoriz;
        var token, decoded, product;
  ...
  checkIfTheSamePersonOrAdmin: function checkIfTheSamePersonOrAdmin() {
    return /*#__PURE__*/function () {
  ...
  authorizeRoles: function authorizeRoles() {
    for (var _len = arguments.length, roles = new Array(_len), _key = 0; _key < _len; _key++) {
      roles[_key] = arguments[_key];
    }
    return function (req, res, next) {
      var _req$headers$authoriz3;
      var token = (_req$headers$authoriz3 = req.headers.authorization) === null || _req$headers$authoriz3 === void 0 ? void 0 : _req$headers$authoriz3.split(' ')[1];
      if (!token) {
  ...
  checkTokenValidation: function checkTokenValidation(req, res, next) {
    var _req$headers$authoriz4;
    var token = (_req$headers$authoriz4 = req.headers.authorization) === null || _req$headers$authoriz4 === void 0 ? void 0 : _req$headers$authoriz4.split(' ')[1];
    if (!token) {
      return res.status(401).json({
        message: 'No token provided'
      });
  ...
  checkIfIsAuthorOrUserPurchase: function () {
    var _checkIfIsAuthorOrUserPurchase = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
      var _req$headers$authoriz5;
      var token, decoded, purchase;
    ...
    function checkIfIsAuthorOrUserPurchase(_x7, _x8, _x9) {
      return _checkIfIsAuthorOrUserPurchase.apply(this, arguments);
    }
    return checkIfIsAuthorOrUserPurchase;
  }()
};
var _default = exports["default"] = AccessControl;