    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _authServices["default"].register(req.body);
        case 3:
          user = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _authServices["default"].login(req.body.email, req.body.password);
        case 3:
          data = _context2.sent;
          res.json(data);
          _context2.next = 11;
        ...
        case 7:
          ...
          res.status(401).send(_context2.t0.message);
        case 11:
        case "end":
...
router.post('/change-password', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, email, oldPassword, newPassword, token, user;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          user = _authServices["default"].verifyToken(token);
          if (!(user.email !== email)) {
            _context3.next = 6;
            break;
          }
        ...
        case 6:
          if (!(_authServices["default"].verifyPassword(email, oldPassword) === false)) {
            _context3.next = 8;
            break;
          }
        ...
        case 8:
          _context3.next = 10;
          return _authServices["default"].changePassword(email, newPassword);
        case 10:
          res.status(204).end();
          _context3.next = 17;
          break;
...
router.post('/forgot-password', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var email, user, token, link, resend, _yield$resend$emails$, error;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          token = _authServices["default"].generateToken({
            email: user.email
          });
          link = "http://localhost:3000/reset-password/".concat(token);
          resend = new _resend.Resend('re_AdzbXU95_BsLv1dqz8YoGfA6SDJ5EsJ9N');
          _context4.next = 12;
          return resend.emails.send({
            from: 'MateTo <support@resend.dev>',
            to: [email],
            subject: 'Forgot Password',
            html: "<p>Click <a href=\"".concat(link, "\">here</a> to reset your password</p>")
          });
        case 12:
          _yield$resend$emails$ = _context4.sent;
...
router.post('/reset-password', /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$body2, token, newPassword, _AuthService$verifyTo, email;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _req$body2 = req.body, token = _req$body2.token, newPassword = _req$body2.newPassword;
          _AuthService$verifyTo = _authServices["default"].verifyToken(token), email = _AuthService$verifyTo.email;
          _context5.next = 5;
          return _authServices["default"].changePassword(email, newPassword);
        case 5:
          res.status(204).end();
