...
var _analitycServices = _interopRequireDefault(require("../services/analitycServices"));
...
var AnalyticsController = {
   ...
   */
  getAnalytics: function getAnalytics(req, res, next) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _req$headers$authoriz, token, decoded, userId, analytics, analyticsTwo;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return _analitycServices["default"].getTotalItemsSales(userId);
          case 6:
            analytics = _context.sent;
            _context.next = 9;
            return _analitycServices["default"].getTopFiveProducts(userId);
          case 9:
            analyticsTwo = _context.sent;
            res.status(200).json({
              data: analytics,
