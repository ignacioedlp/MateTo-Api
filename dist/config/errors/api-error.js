...
var _extandableError = _interopRequireDefault(require("./extandable-error"));
...
var APIError = /*#__PURE__*/function (_ExtendableError) {
  ...
  function APIError(_ref) {
    var message = _ref.message,
      ...
      status = _ref$status === void 0 ? _httpStatus["default"].INTERNAL_SERVER_ERROR : _ref$status,
      _ref$isPublic = _ref.isPublic,
      isPublic = _ref$isPublic === void 0 ? false : _ref$isPublic;
    _classCallCheck(this, APIError);
    return _callSuper(this, APIError, [{
      message: message,
      errors: errors,
      status: status,
      isPublic: isPublic,
